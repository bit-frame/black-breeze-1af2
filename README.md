...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/black-breeze-1af2
```

A live public deployment of this template is available at [https://black-breeze-1af2.templates.workers.dev](https://black-breeze-1af2.templates.workers.dev)
